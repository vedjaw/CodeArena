...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-codearena-dev-key-change-in-production-!@#$%^&*()'
)
...
EXECUTION_MEMORY_LIMIT = os.environ.get('EXECUTION_MEMORY_LIMIT', '256m')
DOCKER_IMAGE_PREFIX = os.environ.get('DOCKER_IMAGE_PREFIX', 'codearena')
...
# Contest Settings
MAX_VIOLATIONS_DEFAULT = 3
AUTO_SUBMIT_ON_MAX_VIOLATIONS = True
WEBCAM_SNAPSHOT_INTERVAL = 60  # seconds
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': BASE_DIR / 'codearena.log',
            'formatter': 'verbose',
        },
    },
    'loggers': {
